...
public class add_products {
    ...
    public GetProductResponse getproducts(int id) {
		GetProductResponse product = product_id.get_products(id);
		return product;
	}
    public LikeResponse likeproducts(int id) {
		LikeResponse like = product_id.like_products(id);
		return like;
	}
    public AddProductResponse addproducts(String name, int price, int product_size_id, int brand_id,int seller_id, int category_id, String image, String described, String ships_from, String ships_from_id, String condition, String dimention, double weight) {
        AddProductResponse addproduct = product_id.add_products(name, price, product_size_id, brand_id, seller_id, category_id, image, described, ships_from, ships_from_id, condition, dimention, weight);
		return addproduct ;
	}
    public AddProductResponse delproducts(int id) {
		
		return product_id.del_products(id);
	}
     public AddProductResponse editproducts(String name, int price, int product_size_id, int brand_id,int seller_id, int category_id, String image, String described, String ships_from, String ships_from_id, String condition, String dimention, double weight,int id) {
     ...
     public AddProductResponse reportproducts(int id, String subject, String details) {
     ...
     public List<ReportProduct> getallreport() {
      ...
      public CommentResponse comment(int id, String comment,int poster , int index, int count) {
		
		return product_id.set_comment_products(id, comment, poster, index, count);
	}
      public CommentResponse getallcomment(int id,int index,int count) {
